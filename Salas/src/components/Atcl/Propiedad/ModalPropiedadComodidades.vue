        ...
        <div class="modal-body">
          ...
          <div class="row g-3">
            <div class=" form-group  px-1 col-md-6">
              ...
              <select v-else-if="propiedadUpdate" class="form-select" v-model="comodidades.estado_general">
              ...
              <select v-else class="form-select " aria-label="Default select example" name="estado_general"
                v-model="comodidades.estado_general">
            ...
            <div class="form-group  px-1 col-md-3">
              ...
              <input v-if="propiedad && propiedad?.cantidad_dormitorios" type="number" class="form-control"
                :value="propiedad.cantidad_dormitorios" readonly>
            ...
            <div class="form-group  px-1 col-md-3">
              ...
              <input v-if="propiedad && propiedad?.banios" type="number" class="form-control" :value="propiedad.banios"
                readonly>
            ...
            <div class="form-group  px-1 col-md-3">
              ...
              <input v-if="propiedad && propiedad?.mLote" type="number" class="form-control" :value="propiedad.mLote"
                readonly>
              <input v-else name="m_Lote" type="number" class="form-control " id="" min="0" placeholder="Ej: 500"
                v-model="comodidades.lotes">
            </div>
            <div class="form-group  px-1 col-md-3">
              ...
              <input v-else name="m_Cubiertos" type="number" class="form-control " id="" placeholder="Ej: 300"
                v-model="comodidades.lote_cubierto">
            </div>
            <div class="form-group  px-1 col-md-3 ">
              <label class="text-center" id="basic-addon1">Cochera</label>
              <input v-if="propiedad" type="text" class="form-control" :value="propiedad.cochera || ''" readonly>
            ...
            <div class="form-group  px-1 col-md-3 ">
              ...
              <input v-else name="numero_cochera" type="number" class="form-control " id="" placeholder="Ej: 2"
                v-model="comodidades.numero_cochera">
            </div>

            <div class="form-group  px-1 col-md-3 ">
              <label class="text-center" id="basic-addon1">Asfalto</label>
              <input v-if="propiedad" type="text" class="form-control" :value="propiedad.asfalto || ''" readonly>
            ...
            <div class="form-group  px-1 col-md-3 ">
              ...
              <input v-if="propiedad" type="text" class="form-control" :value="propiedad.gas || ''" readonly>
            ...
            <div class="form-group  px-1 col-md-3 ">
              ...
              <input v-if="propiedad" type="text" class="form-control" :value="propiedad.cloaca || ''" readonly>
            ...
            <div class="form-group  px-1 col-md-3">
              ...
              <input v-if="propiedad" type="text" class="form-control" :value="propiedad.agua || ''" readonly>
