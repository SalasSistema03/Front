...
const buscarFolioPrecargado = async () => {
  ...
  try {
  //console.log("Buscando folio:", form.value);
    ...
    //console.log("Datos precargados recibidos:", datos);
    ...
    if (datos) {
      ...
      if (datos.proceso_monto) form.value.monto_alquiler = datos.monto_alquiler_comercial;
      ...
      if (datos.informe) form.value.informe = datos.informe;
    ...
    console.log("No se encontraron datos precargados para este folio",err);
